...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "v", awesome.quit,
    ...
    awful.key({ modkey,           }, "p",     function () awful.tag.incncol(-1, nil, true)    end,
    ...
    awful.key({ modkey,           }, "d", function () awful.spawn(cmdmenu) end,
              {description = "open a cmdmenu (launcher)", group = "launcher"}),
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey,          }, "b", 
        function (c) 
            c.screen.wibar.visible = not c.screen.wibar.visible
        end,
        {description = "toggle bar on current screen", group = "client"}),
